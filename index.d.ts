...
declare namespace CDP {
  ...
  type DoEventPromises<D extends string> = {
    [event in GetEvent<D>]: // eslint-disable-next-line @typescript-eslint/no-invalid-void-type
    () => Promise<
      GetReturnType<D, event> extends undefined ? void : GetReturnType<D, event>
    >;
  };
...
export function Activate(options: CDP.ActivateOptions): Promise<void>;

export function Close(
  options: CDP.CloseOptions,
  callback: (err: Error | null) => void,
): void;
export function Close(options: CDP.CloseOptions): Promise<void>;
...
export function List(options?: CDP.BaseOptions): Promise<CDP.Target[]>;
...
export function New(options?: CDP.NewOptions): Promise<CDP.Target>;
...
export function Protocol(options?: CDP.ProtocolOptions): Promise<CDP.Protocol>;
...
export function Version(options?: CDP.BaseOptions): Promise<CDP.VersionResult>;
